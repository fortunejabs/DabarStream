...
BOOK_LOCAL_TO_ENGLISH = {
    ...
    # --- Bemba (must stay in sync with BOOK_ALIASES in server.py) ---
    "ututendelo": "genesis",
    "ukufuma": "exodus",
    "abena roma": "romans",
    "mafumu": "kings",
    ...
    "yobu": "job",
    "amalango": "leviticus",
    "abena korinto": "corinthians",
    "abena galatiya": "galatians",
    "abena efeso": "ephesians",
    "abena filipi": "philippians",
    "abena kolosai": "colossians",
    "abena tesalonika": "thessalonians",
    "abena heburani": "hebrews",
    "ukubvumbuluka": "revelation",
    # --- Nyanja / Chewa numbered forms (import parity with server.py) ---
    "1 akorinto": "1 corinthians",
    "2 akorinto": "2 corinthians",
